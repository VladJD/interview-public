...
public interface AccountService {
     ...
     */
    void transfer(Account source, Account target, double amount) throws AccountNotFoundException, InsufficientAccountBalanceException, AmountIsInvalidException;
}
